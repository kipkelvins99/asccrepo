                ...
                if account_payment:
                    for pay in account_payment:
                            ...
                            if due1 == [{'due1': None}]:
                                ...
                                if move.date == pay.date and pay.is_reconciled is False and \
                                        0 < difference_in_days <= 30 and pay.payment_type == 'inbound':
                                    amount_total = 0.0
                                ...
                                record.extend(due1)
                                if move.date == pay.date and pay.is_reconciled is False and \
                                        pay.payment_type == 'inbound' and 0 < difference_in_days <= 30:
                                    amount_total = 0.0
                                    amount_total += pay.amount
                                    due1 = round(float(record[2]['due1']) - amount_total, 2)
                                    record[2]['due1'] = due1
                            ...
                            if due2 == [{'due2': None}]:
                                ...
                                if move.date == pay.date and pay.is_reconciled is False and \
                                        pay.payment_type == 'inbound' and 30 < difference_in_days <= 60:
                                    amount_total = 0.0
                                    amount_total += pay.amount
                            ...
                            if due3 == [{'due3': None}]:
                                ...
                                if move.date == pay.date and pay.is_reconciled is False and \
                                        pay.payment_type == 'inbound' and 60 < difference_in_days <= 90:
                                    amount_total = 0.0
                                    amount_total += pay.amount
                            ...
                            if due4 == [{'due4': None}]:
                                ...
                                if move.date == pay.date and pay.is_reconciled is False and \
                                        pay.payment_type == 'inbound' and 90 < difference_in_days <= 120:
                                    amount_total = 0.0
                                    amount_total += pay.amount
                            ...
                            if due5 == [{'due5': None}]:
                                ...
                                if move.date == pay.date and pay.is_reconciled is False and \
                                        pay.payment_type == 'inbound' and difference_in_days > 120:
                                    amount_total = 0.0
                                    amount_total += pay.amount
                                ...
                                record.extend(due5)
                                if move.date == pay.date and pay.is_reconciled is False and \
                                        pay.payment_type == 'inbound' and difference_in_days <= 30:
                                    amount_total = 0.0
                                    amount_total += pay.amount
                                    due5 = round(float(record[6]['due5']) - amount_total, 2)
                                    record[6]['due5'] = due5
